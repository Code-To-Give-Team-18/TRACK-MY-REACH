...
export default function TestAuthPage() {
 ...
 <h1 className="text-3xl font-bold mb-8 text-gray-900 ">Authentication Test Page</h1>
 
 <div className="bg-white p-6 rounded-lg shadow mb-6">
 <h2 className="text-xl font-semibold mb-4 text-gray-900 ">Current State</h2>
 ...
 <div className="bg-white p-6 rounded-lg shadow mb-6">
 <h2 className="text-xl font-semibold mb-4 text-gray-900 ">Test Credentials</h2>
