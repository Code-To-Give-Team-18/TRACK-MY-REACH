...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-orange-50 to-white pt-16 pb-8">
      {/* Newsletter Section */}
      <div className="container mx-auto px-4 mb-12">
        <div className="bg-gradient-to-r from-orange-500 to-pink-500 rounded-3xl p-8 md:p-12 text-white shadow-xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <Button
                type="submit"
                className="bg-white hover:bg-gray-100 text-orange-600 font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all"
              >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-gray-800">REACH Foundation</h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/schools" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Partner Schools
                </Link>
              </li>
              <li>
                <Link href="/volunteer" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Volunteer
                </Link>
              </li>
              <li>
                <Link href="/fundraise" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Fundraise
                </Link>
              </li>
              <li>
                <Link href="/monthly-giving" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Monthly Giving
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about/mission" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Our Mission
                </Link>
              </li>
              <li>
                <Link href="/about/team" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
                <Link href="/about/impact" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Impact Report
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/transparency" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Transparency
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+852-1234-5678" className="text-gray-600 hover:text-orange-600 transition-colors">
                  +852 1234 5678
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-orange-500 flex-shrink-0" />
                <a href="mailto:hello@reach.org.hk" className="text-gray-600 hover:text-orange-600 transition-colors">
                  hello@reach.org.hk
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-100 to-orange-100 px-6 py-3 rounded-full">
            <Heart className="w-5 h-5 text-orange-500 animate-pulse" />
            <span className="text-sm font-medium text-gray-700">
              Your donation can change a life today
            </span>
            <Link href="/donate">
              <Button size="sm" className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white rounded-full px-4 py-1 text-xs">
                Donate Now
              </Button>
            </Link>
          </div>
