...
export default function StoriesHighlight() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-green-50 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-10 right-20 w-24 h-24 bg-green-200 rounded-full opacity-20 animate-pulse"></div>
      <div className="absolute bottom-10 left-20 w-32 h-32 bg-emerald-200 rounded-full opacity-20 animate-pulse animation-delay-2000"></div>
              ...
              >
                ...
                <div className="flex-shrink-0">
                  <div className="relative">
                    <div 
                      className="w-56 h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 transform rotate-45 overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 bg-gradient-to-br from-green-50 via-white to-emerald-50 border-2 border-white/50"
                    >
                      {story.video_link ? (
                        <video
                        ...
                        <div className="absolute inset-0 flex items-center justify-center transform -rotate-45 bg-gradient-to-br from-green-100/50 to-emerald-100/50">
                ...
                <div className={`flex-1 ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                  <div className={`space-y-4 ${index % 2 === 1 ? 'md:ml-auto' : ''}`}>
                    <div>
                      <p className="text-sm font-semibold text-green-600 uppercase tracking-wider mb-2">Impact Story</p>
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      Thanks to <span className="text-green-600 font-semibold">your generosity</span>, 
                    ...
                    <div className={`inline-flex items-center gap-3 ${index % 2 === 1 ? 'md:ml-auto' : ''}`}>
                      <Link href={`/child?id=${story.child_id}`}>
                        <button className="group/btn bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 inline-flex items-center gap-2">
